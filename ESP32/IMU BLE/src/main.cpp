...
void printStructed(ICM_20948_I2C *sensor) {
  ...
  char* string;
  int num;
  if(0 > (num = asprintf(&string, "%d: \t %f \t %f \t %f \t %f \t %f \t %f \t %f \t %f \t %f", i++ ,sensor->accX(), sensor->accY(), sensor->accZ(), sensor->gyrX(), sensor->gyrY(), sensor->gyrZ(), sensor->magX(), sensor->magY(), sensor->magZ()))) return;
